...
from app.models import Product, Order, Review, LikeProduct, LikeReview, Profile, Category
...
class RegisterForm(forms.Form):
    ...
    birth_date = forms.DateField(widget=forms.DateInput(attrs={'placeholder': 'YYYY-MM-DD'}), label="Дата рождения")
    sex = forms.CharField(widget=forms.TextInput(attrs={'placeholder': 'Male/Female'}), label="Пол")
...
class ReviewForm(forms.ModelForm):
    class Meta:
        ...
        fields = ('content',)
        widgets = {
            "content": forms.Textarea(attrs={"class": "form-control mb-3", "placeholder": "Введите сюда свой комментарий.", "rows" : "8"})
        }
